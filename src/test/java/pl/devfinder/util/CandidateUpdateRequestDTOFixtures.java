...
@UtilityClass
public class CandidateUpdateRequestDTOFixtures {

    public static CandidateUpdateRequestDTO someCandidateUpdateRequestDTO1() {
        return CandidateUpdateRequestDTO.builder()
                .candidateId(1L)
